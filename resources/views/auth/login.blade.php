                            ...
                            <div class="misc-box">
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="form-group">
                                        <label  for="exampleuser1">Username Email</label>
                                    ...
                                    <input class="form-check-input" type="checkbox" name="remember" id="remember" {{ old('remember') ? 'checked' : '' }} style="margin-left: 1px; margin-top: 5px;">
